  ...
  <body>
     <?php include('../estructura/header.php'); ?>
            <section>
                ...
                <!-- formulario registro de clientes CSS -->

                    <div class="col pt-3 ">
                    <h3 class="text-center"> Registrar Nuevo Cliente </h3><hr>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group ">
                                      ...
                                      <div class="form-group">
                                      <div class="col-md-5">
                                        <a href="formulario_listado_cliente.php?pagina=1">
                                        <button type="button" class="btn btn-primary btn-lg btn-block info">Lista de Clientes</button>
                                      </a></div>
